...
@section('content')
    ...
    <div class="d-flex flex-row justify-content-between w-100">
        ...
        <div class="p-5 dashboard-subcontainer-main">
            <div class="d-flex flex-row quick-metrics-container w-100 mb-5 flex-wrap">
                <div class="quick-metric d-flex flex-row gap-3 align-items-center bg-paleblue">
                ...
                <div class="quick-metric d-flex flex-row gap-3 align-items-center bg-palered">
                ...
                <div class="quick-metric d-flex flex-row gap-3 align-items-center bg-palegreen">
                ...
                <div class="quick-metric d-flex flex-row gap-3 align-items-center bg-paleyellow">
        ...
        <!-- Sidebar content -->
        <aside class="p-5 dashboard-subcontainer-aside">
